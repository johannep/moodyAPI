...
time.end = 16;        %   [s]     End time of simulation
time.dt = 1e-4;     %   [s]     Time step size
time.cfl = 0.6; % use adaptive time step based on max courant number

print.dt = 1e-2;    % save results every 0.01 s

gravity = 1;            % [-]       Gravity is 1=on, 0=off (9.81 m/s2)
...
bc2.frequency = 0.8;  % if scalar it is applied to all dimensions.
