function moodySystemMovie(d,t,dims,varargin)

% Get number of objects. 
nCables=length(d.nCables);
nRBs = length(rbs);
...
% Check time: 
if nargin < 2 || ischar(t)
    t=d.t;
end



%% MOODYSYSTEMMOVIE shows position movie of the whole system
% movie is stored as system.<d.name>_field.mp4 in the current directory. 
%
% Input: 
